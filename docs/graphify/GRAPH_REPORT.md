...
2. `PetscInterface` - 53 edges
3. `PicChunk` - 44 edges
4. `PicPoissonBasic::Impl` - 42 edges
...
- `copy_chunk_to_src()` --references--> `ChunkAccessor`  [EXTRACTED]
  pic/pic_poisson_petsc.cpp → elliptic/chunk_accessor.hpp
- `copy_sol_to_chunk()` --references--> `ChunkAccessor`  [EXTRACTED]
  pic/pic_poisson_petsc.cpp → elliptic/chunk_accessor.hpp
- `solve()` --references--> `ChunkAccessor`  [EXTRACTED]
  pic/pic_poisson_petsc.cpp → elliptic/chunk_accessor.hpp
- `update_mapping()` --references--> `ChunkAccessor`  [EXTRACTED]
  pic/pic_poisson_petsc.cpp → elliptic/chunk_accessor.hpp
- `set_boundary_field()` --calls--> `get_nb_rank()`  [INFERRED]
...
Cohesion: 0.20
Nodes (18): Dims3D, DM, PetscScatter(), float64, IS, Vec, vector, get_indexset() (+10 more)

### Community 2 - "Community 2"
Cohesion: 0.11
Nodes (22): calculate_moment(), calculate_moment_openmp(), json, PicApplication(), PtrInterface, string, create_poisson_interface(), exchange_emf_boundaries() (+14 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (22): json, NIX_NAMESPACE_BEGIN, tuple, vector, from_json(), get_coordinate(), get_rank_boundary(), namespace() (+14 more)
...
Cohesion: 0.15
Nodes (18): IntegrationCase, generate_plots(), _generate_snapshot(), _get_profile_path(), _normalized(), _plot_energy_history(), generate_plots(), _generate_snapshot() (+10 more)

### Community 6 - "Community 6"
Cohesion: 0.21
Nodes (21): analyze_run(), cmd_all(), cmd_analyze(), cmd_build(), cmd_compare(), cmd_plots(), cmd_run(), cmd_update_golden() (+13 more)
...
Cohesion: 0.05
Nodes (53): BaseMoment, cc, dx, dy, dz, has_xdim, has_ydim, has_zdim (+45 more)

### Community 11 - "Community 11"
Cohesion: 0.10
Nodes (29): mt19937_64, get_nb_rank(), float64, T_array, T_int, test_append_current1d_scalar(), test_append_current1d_xsimd(), test_append_current2d_scalar() (+21 more)
...
Cohesion: 0.08
Nodes (46): BaseVelocity, cc, cflx, cfly, cflz, dx, dy, dz (+38 more)

### Community 15 - "Community 15"
Cohesion: 0.15
Nodes (31): float32, calculate_global_offset(), close_file(), float64, json, MPI_File, MPI_Request, string (+23 more)

### Community 16 - "Community 16"
Cohesion: 0.18
Nodes (26): ChunkT, analytic_solution(), analytic_source(), compute_kappa_component(), compute_rank_from_chunk_coords(), flatten_chunk_index(), array, Bool3D (+18 more)
...
Cohesion: 0.13
Nodes (35): BaseMaxwell, boundary_margin, cc, dt, dx, dy, dz, lbx (+27 more)

### Community 20 - "Community 20"
Cohesion: 0.04
Nodes (48): Application, assert_mpi, cdims, chunkvec, cl_argc, cl_argv, curstep, curtime (+40 more)

### Community 21 - "Community 21"
Cohesion: 0.17
Nodes (14): copy_chunk_to_src(), copy_sol_to_chunk(), get_interface(), scatter_forward(), scatter_reverse(), set_interface(), set_option(), solve() (+6 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (30): analytic_solution(), analytic_source(), cleanup_config_and_tmpdir(), cleanup_tmpdir(), CliArgs, args, argv, compute_kappa_component() (+22 more)
...
Cohesion: 0.10
Nodes (13): ChunkAccessor, build_global_index, get_num_chunks, get_num_grids_per_chunk, get_num_grids_total, pack, unpack, copy_chunk_to_src() (+5 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (51): apply_operator_1d_primitive(), apply_operator_2d_primitive(), apply_operator_3d_primitive(), flat_index(), float64, OperatorChunkData, delx, dely (+43 more)
...
Cohesion: 0.22
Nodes (4): get_mpi_size(), get_mpi_size(), require_mpi_size(), require_mpi_size()

### Community 30 - "Community 30"
Cohesion: 0.20
Nodes (9): T, get_nprocess(), get_thisrank(), init_array_ordered(), init_array_random(), is_array_equal(), parallel_decomposition(), get_mpi_size() (+1 more)

### Community 31 - "Community 31"
Cohesion: 0.53
Nodes (5): check_sort1d(), check_sort2d(), check_sort3d(), set_random_particle(), Particle

### Community 32 - "Community 32"
Cohesion: 0.04
Nodes (48): Dims3D, DM, PetscInterface, float64, KSP, Mat, OptionVec, Vec (+40 more)
...
Cohesion: 0.22
Nodes (6): SolverInterface, copy_chunk_to_src, copy_sol_to_chunk, set_option, solve, update_mapping
...
Cohesion: 0.18
Nodes (6): CfgParser(), NIX_NAMESPACE_BEGIN, DebugFormatter, DebugPrinter, nstring, Record
...
Cohesion: 0.09
Nodes (38): BaseCurrent, dx, dy, dz, has_xdim, has_ydim, has_zdim, is_odd (+30 more)
...
Cohesion: 0.05
Nodes (39): float64, ParticleVec, PicChunk, xtensor, allocate, allocate_mpi_buffers, cc, compute_efield_poisson (+31 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (6): object, DiagHandler, FieldDiagHandler, LoadDiagHandler, ParticleDiagHandler, TracerDiagHandler

### Community 64 - "Community 64"
Cohesion: 0.13
Nodes (14): float64, PicPoissonBasic::Impl, PicChunk, PicChunkAccessor, vector, chunk_work, delh, global_dims (+6 more)
...
Cohesion: 0.07
Nodes (27): float64, PicApplication, vector, calculate_moment, calculate_moment_openmp, create_poisson_interface, exchange_emf_boundaries, exchange_phi_boundaries (+19 more)

### Community 77 - "Community 77"
Cohesion: 0.11
Nodes (27): _build_ohm_matrices_2d(), _build_source_term_1d(), _build_source_term_2d(), calc_e_ohm_1d(), calc_e_ohm_2d(), _periodic_first_difference_matrix(), _periodic_second_difference_matrix(), qm_per_species_from_config() (+19 more)

### Community 79 - "Community 79"
Cohesion: 0.08
Nodes (22): _MockRun, 2D Ex/Ey coupled Fourier verification with periodic boundary conditions.      Ma, solve_ohm_2d rejects invalid input shapes., Default path matches the path with precomputed base matrices., End-to-end: build um for 3 species, transform, solve, check Fourier.      Synthe, On a manufactured problem, CG converges (status 0)., Minimal picnix.Run stub for testing calc_e_ohm_1d / _2d., A1 and A2 should be symmetric for the 2D periodic system. (+14 more)

### Community 81 - "Community 81"
Cohesion: 0.11
Nodes (7): float64, MockChunk, boundary_margin, delh, Nx, Ny, Nz
...
Cohesion: 0.10
Nodes (21): Dims3D, DM, PetscScatter, IS, dims, dm_ptr, get_indexset, get_indexset_global (+13 more)

### Community 91 - "Community 91"
Cohesion: 0.31
Nodes (16): PtrInterface, string, Vector, load(), load_application(), load_chunkvec(), load_chunkvec_content(), load_chunkvec_header() (+8 more)

### Community 92 - "Community 92"
Cohesion: 0.11
Nodes (19): BasePosition, cc, dx, dy, dz, lbx, lby, lbz (+11 more)

### Community 93 - "Community 93"
Cohesion: 0.21
Nodes (14): build_poisson_matrix_1d(), build_poisson_matrix_2d(), build_poisson_matrix_3d(), DM, float64, Mat, Dims3D, PetscPoisson() (+6 more)
...
Cohesion: 0.11
Nodes (17): ChunkViewVec, Dims3D, float64, PicPoisson, bind_chunks, chunk_dims, chunk_views, copy_chunk_to_src (+9 more)

### Community 99 - "Community 99"
Cohesion: 0.12
Nodes (17): Advanced Topics, Anti-Patterns, File Purposes, FIRST: Restore Context (v2.2.0), Important: Where Files Go, Parallel task workflow, Planning with Files, Quick Start (+9 more)

### Community 100 - "Community 100"
Cohesion: 0.12
Nodes (17): Impl, PicPoissonPetsc, impl, unique_ptr, copy_chunk_to_src, copy_sol_to_chunk, get_vector_sol_g, get_vector_src_g (+9 more)

### Community 101 - "Community 101"
Cohesion: 0.19
Nodes (6): convert_tracer_to_hdf5(), Histogram2D, is_valid_tracer_hdf5(), remove_tracer_file_after_confirmation(), sort_and_split_particle_id(), Tracer
...
Cohesion: 0.13
Nodes (15): Solver, copy_chunk_to_src, copy_sol_to_chunk, finalize, get_interface, initialize, scatter_forward, scatter_reverse (+7 more)

### Community 105 - "Community 105"
Cohesion: 0.18
Nodes (5): balancer, cfgparser, get_basedir, is_initial_run, unique_ptr
...
Cohesion: 0.15
Nodes (7): Dims3D, float64, PicPoissonPetsc(), PicPoissonPetsc::Impl, delx, dely, delz
...
Cohesion: 0.19
Nodes (10): func_table_t, integer_sequence, push_position(), Current, size_table, table, fill_table_entries(), Position (+2 more)

### Community 111 - "Community 111"
Cohesion: 0.23
Nodes (8): doit_job(), field_aligned_basis(), Plot transverse B field with helicity decomposition (x-t diagram)., Return field-aligned basis vectors e1 (||B), e2, e3 (perp B)., Plot initial, final, and difference of electron VDF in (v_par, v_perp)., Plot delta B^2 / B_0^2 vs time (log scale)., Plot electron T_perp / T_parallel vs time (linear scale)., Run

### Community 112 - "Community 112"
Cohesion: 0.33
Nodes (4): float64, T_data, Maxwell, T_chunk
...
Cohesion: 0.15
Nodes (12): count_cell_within_fireball(), Bool3D, Dims3D, float64, json, PtrChunk, is_inside_fireball(), MainApplication (+4 more)
...
Cohesion: 0.18
Nodes (11): Impl, PicPoissonBasic, impl, unique_ptr, copy_chunk_to_src, copy_sol_to_chunk, scatter_forward, scatter_reverse (+3 more)
...
Cohesion: 0.28
Nodes (7): deposit_moment(), call_entry(), Moment, size_table, table, set_boundary(), T_position
...
Cohesion: 0.57
Nodes (5): resolve_from_active_file(), resolve_from_env(), resolve_latest_dir(), resolve-plan-dir.sh script, slug_is_valid()
...
Cohesion: 0.40
Nodes (4): Physical Parameters, References, Scenarios, Temperature Anisotropy Driven Instability

### Community 161 - "Community 161"
Cohesion: 0.40
Nodes (4): Collisionless Shock Transition Layer (Foot), Physical Parameters, References, Scenarios
...
Cohesion: 0.50
Nodes (4): Strategy 1: Context Reduction, Strategy 2: Context Isolation (Multi-Agent), Strategy 3: Context Offloading, The 3 Context Engineering Strategies

### Community 167 - "Community 167"
Cohesion: 0.50
Nodes (4): OptionVec, string, T, is_option_valid()
