...
## Corpus Check
- 146 files · ~132,935 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1006 nodes · 1645 edges · 60 communities detected
...
- `save_application()` --calls--> `to_json()`  [INFERRED]
  nix/statehandler.hpp → pic/pic_application.cpp
- `size()` --calls--> `PicChunkAccessor::get_num_chunks()`  [INFERRED]
  nix/chunk.hpp → pic/pic_poisson.cpp
- `size()` --calls--> `get_size_byte()`  [INFERRED]
  nix/chunk.hpp → pic/pic_chunk.cpp
- `begin_bc_exchange()` --calls--> `set_boundary_begin()`  [INFERRED]
  nix/chunk.hpp → pic/pic_chunk.cpp
...
Cohesion: 0.05
Nodes (53): DEFINE_MEMBER(), begin_bc_exchange(), data(), MpiBuffer::get_size_byte(), MpiBuffer::pack(), MpiBuffer::unpack(), pack(), pack_bc_exchange() (+45 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (40): probe_bc_exchange(), calculate_moment(), calculate_moment_openmp(), create_poisson_interface(), exchange_emf_boundaries(), exchange_phi_boundaries(), initialize(), initialize_diagnostic() (+32 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (36): ChunkMap(), get_chunkid(), get_coordinate(), get_neighbor_coord(), get_rank(), get_rank_boundary(), is_chunk_active(), set_rank_boundary() (+28 more)
...
Cohesion: 0.08
Nodes (26): IntegrationCase, Histogram2D, doit_job(), Run, generate_plots(), _generate_snapshot(), _get_profile_path(), _load_picnix() (+18 more)

### Community 6 - "Community 6"
Cohesion: 0.1
Nodes (30): namespace(), FileSystemEventHandler, analyze_run(), cmd_all(), cmd_analyze(), cmd_build(), cmd_compare(), cmd_plots() (+22 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (21): build_poisson_matrix_1d(), build_poisson_matrix_2d(), build_poisson_matrix_3d(), PetscPoisson, PetscPoisson1D, PetscPoisson2D, PetscPoisson3D, set_matrix() (+13 more)

### Community 8 - "Community 8"
Cohesion: 0.1
Nodes (32): set_coordinate(), set_global_context(), object, allocate(), sort_particle(), make_chunk_impl(), make_boundary_config(), apply_sinusoidal_field() (+24 more)
...
Cohesion: 0.1
Nodes (26): count_cell_within_fireball(), generate_injection_particle(), is_inside_fireball(), main(), MainApplication, MainChunk, MainInterface, BaseMoment (+18 more)

### Community 11 - "Community 11"
Cohesion: 0.16
Nodes (25): BaseCurrent, call_scalar_impl(), call_vector_impl(), global1d(), global2d(), global3d(), local1d(), local2d() (+17 more)
...
- **Thin community `Community 25`** (11 nodes): `pic_poisson_basic.cpp`, `pic_poisson_basic.hpp`, `copy_chunk_to_src()`, `copy_sol_to_chunk()`, `Impl()`, `PicPoissonBasic()`, `scatter_forward()`, `scatter_reverse()`, `set_option()`, `solve()`, `update_mapping()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (7 nodes): `test_xtensor_particle.cpp`, `check_sort1d()`, `check_sort2d()`, `check_sort3d()`, `MockChunk`, `.MockChunk()`, `set_random_particle()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (6 nodes): `DiagIoHandler()`, `MpiioDiagIoHandler`, `.MpiioDiagIoHandler()`, `PosixDiagIoHandler`, `.PosixDiagIoHandler()`, `io_handler.hpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (5 nodes): `test_diag_resource.cpp`, `MockPacker`, `.MockPacker()`, `MockResourceDiagBase`, `.MockResourceDiagBase()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (5 nodes): `tracer.hpp`, `TracerDiag`, `.TracerDiag()`, `TracerPacker`, `.TracerPacker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (5 nodes): `tracer_pickup.hpp`, `TracerPickupDiag`, `.TracerPickupDiag()`, `TracerPickupPacker`, `.TracerPickupPacker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (5 nodes): `ParticleDiag`, `.ParticleDiag()`, `ParticlePacker`, `.ParticlePacker()`, `particle.hpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (4 nodes): `elliptic.hpp`, `Solver`, `SolverInterface`, `.SolverInterface()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (4 nodes): `LoadPacker`, `RankPacker`, `.RankPacker()`, `load.hpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (3 nodes): `DebugFormatter`, `DebugPrinter`, `debug.hpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (3 nodes): `test_application.cpp`, `TestApplication`, `.TestApplication()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (3 nodes): `test_chunk.cpp`, `TestChunk`, `.TestChunk()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (3 nodes): `PicDiag`, `.PicDiag()`, `pic_diag.hpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 52`** (3 nodes): `HistoryDiag`, `.HistoryDiag()`, `history.hpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (2 nodes): `test_chunkmap.cpp`, `ChunkMapTest`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (2 nodes): `test_logger.cpp`, `TestLogger`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (2 nodes): `PicPacker`, `pic_packer.hpp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `Native Async I/O (Deferred)`, `Async I/O deferred due to MPI buffer lifetime risks and future SENSEI/Ascent alternatives`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `Future Hybrid Module`, `Module Extension Model (nix owns mechanics, modules own interpretation)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (2 nodes): `Diagnostic Module Refactor`, `Diagnostic refactor designed as mechanical move with minimal behavior change`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (1 nodes): `PIC-NIX Project`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (1 nodes): `Catch2 v3 Test Framework`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (1 nodes): `nix External Repository (github.com/amanotk/nix)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (1 nodes): `PIC module auto-enables elliptic and nix modules`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `size()` connect `Community 1` to `Community 2`, `Community 3`, `Community 4`, `Community 8`, `Community 9`, `Community 12`, `Community 17`, `Community 22`, `Community 27`?**
  _High betweenness centrality (0.178) - this node is a cross-community bridge._
- **Why does `load()` connect `Community 6` to `Community 0`, `Community 1`, `Community 4`, `Community 13`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `Run` connect `Community 0` to `Community 8`, `Community 5`?**
